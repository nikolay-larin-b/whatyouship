...
The project is in an early stage of development. Its planned actions are:

* ``inspect`` to show what a release contains.
* ``lint`` to flag suspicious or unwanted contents.
